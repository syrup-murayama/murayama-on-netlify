...
//    'gulp vendor'
//          vendor:clean - vendor:js - vendor:bulma:sass - vendor:css - vendor:fonts
//    'gulp fonts'
//    'gulp sass'
...
//     gulp-uglify, lodash.assign, gulp-imagemin
...
// maybe sometimes we didn't run default tasks, so we run it below before prod build tasks
